function attachSolutionButtonListeners_answer8(button) {
    button.addEventListener('click', function() {
        ...
        checkAnswer8(correctAnswers, solutionInfoId, this.dataset.solutionText);
    });
}

function checkAnswer8(correctAnswers, solutionInfoId, solutionText) {
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.solutionButton').forEach(button => {
        attachSolutionButtonListeners_answer8(button);
    });
});

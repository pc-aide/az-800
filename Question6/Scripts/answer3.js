function attachSolutionButtonListeners_question3(button) {
    button.addEventListener('click', function() {
        ...
        if (selectedAnswer && selectedAnswer.value === 'a policy') {
            document.querySelector('input[name="question3"][value="a policy"]').parentElement.classList.add('highlight');
        } else {
            document.querySelector('input[name="question3"][value="a policy"]').parentElement.classList.add('incorrect');
            allCorrect = false;
        }
